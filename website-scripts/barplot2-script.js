...
function barplot2() {
        ...
        d3.csv("2022classdrugs.csv").then(csvData => {
        ...
        d3.select("#toggleDropdown2").on("change", function() {
        ...
        d3.select("#drugGvBDropdown2").on("change", function() {
            const selectedVal = d3.select(this).property("value");
            //debug
        ...
        function filterData() {
            let filtered = data;
            //filter to only generic or brand
